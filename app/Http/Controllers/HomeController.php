...
class HomeController extends Controller
{
    ...
    public function showEditBbForm(Comment $bb)
    {
        return view('bb_edit', ['bb' => $bb]);
    }

    public function updateBb(Request $request, Comment $bb)
    {
    ...
    public function showDeleteBbForm(Comment $bb)
    {
        return view('bb_delete', ['bb' => $bb]);
    }

    public function destroyBb(Comment $bb)
    {
        $bb->delete();
        return redirect()->route('home');
    }
